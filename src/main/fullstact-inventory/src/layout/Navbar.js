      ...
      <nav className="navbar navbar-expand-lg navbar-light bg-light">
        <div className="container-fluid" style={{ backgroundColor: "" }}>
          ...
          <div className="d-flex justify-content-end ">
            <div data-testid="producttbl">
            <Link className="btn btn-dark me-2" to="/product" id="search">
              Product Table{" "}
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
            ...
            <div data-testid="requesttbl">
            <Link className="btn btn-dark me-2" to="/request" id="searchReq">
              Request Table{" "}
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
            ...
            <div data-testid="retailertbl">
            <Link className="btn btn-dark me-2" to="/retailer" id="searchRetail">
              Retailer Table{" "}
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
